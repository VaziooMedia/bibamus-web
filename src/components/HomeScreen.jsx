    ...
    <div style={{ padding: "20px 20px 28px 20px", display: "flex", flexDirection: "column", flex: 1 }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "28px", marginBottom: "14px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px", width: "68px" }}>
          ...
          >
            <svg width="28" height="28" viewBox="425 130 405 1070" fill="none">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                fill={COLORS.amber}
              ...
              <path d="M542 800l60 60 110-120" fill="none" stroke={COLORS.paper} strokeWidth="55" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
