// ============================================================
// BibaPlay — Jalon 1 : le socle (créer/rejoindre une partie, écran
// d'attente avec le code et les participants). Pas encore de vraie
// logique de jeu (questions, chrono, scoring) — ça viendra dans un
// prochain jalon, une fois ce socle validé.
// ============================================================
...
// --- Écran d'entrée standalone (depuis la tuile BibaPlay sur Home) : créer ou rejoindre une
// partie avec un code, comme pour un BibaRoom classique. ---
export function BibaPlayHubScreen({ onBack, onCreate, onJoin }) {
...
// --- Écran de la partie elle-même : code (si indépendante), participants déjà présents, et
// bouton "Démarrer" pour l'hôte. Jalon 1 seulement — pas encore de vraies questions après le
// démarrage. ---
export function BibaPlayGameScreen({ game, myBibroCode, onBack, onStart }) {
      ...
      <div style={{ marginTop: "auto" }}>
        {game.status === "waiting" ? (
          ...
          <p style={{ textAlign: "center", fontSize: "13px", color: COLORS.inkSoft }}>
            La partie a démarré — les pronostics arrivent dans un prochain bloc BibaPlay.
          </p>
        )}
      </div>
