  ...
  return (
    <div style={{ padding: "28px 20px", display: "flex", flexDirection: "column", flex: 1 }}>
      ...
      {event.spotifyPlaylistId ? (
        <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: playbackError ? "4px" : "6px", flexWrap: "wrap" }}>
        <a
      ...
      {event.spotifyPlaylistId && (event.nowPlayingTrack ? (
        ...
        <p style={{ fontSize: "12px", color: COLORS.inkSoft, fontStyle: "italic", marginTop: 0, marginBottom: "18px" }}>
