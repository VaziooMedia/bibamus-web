...
export async function loadMyProfile(userId) {
  ...
  return {
    ...
    genderCustom: data.gender_custom || "",
...
function rowToVenue(row) {
  return {
    ...
    hasOccasionalKaraoke: !!row.has_occasional_karaoke,
    hasOccasionalConcerts: !!row.has_occasional_concerts,
    hasBilliards: !!row.has_billiards,
    hasFoosball: !!row.has_foosball,
    hasDarts: !!row.has_darts,
    hasBingo: !!row.has_bingo,
    hasSnacks: !!row.has_snacks,
...
function venueToRow(v, partial = false) {
  const row = {
    ...
    has_occasional_karaoke: v.hasOccasionalKaraoke,
    has_occasional_concerts: v.hasOccasionalConcerts,
    has_billiards: v.hasBilliards,
    has_foosball: v.hasFoosball,
    has_darts: v.hasDarts,
    has_bingo: v.hasBingo,
    has_snacks: v.hasSnacks,
